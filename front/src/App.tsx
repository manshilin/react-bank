...
import { AuthProvider } from "./context/authContext"; // Імпортуйте AuthProvider

function App() {
  return (
    <Page>
      <AuthProvider> {/* Використовуйте AuthProvider замість AuthContext.Provider */}
        <BrowserRouter>
          <Routes>
            <Route
              path="/"
              element={<AuthRoute element={<WellcomePage />} />}
            />
            <Route
              path="/signup"
            ...
            <Route
              path="/signup-confirm"
              element={<PrivateRoute element={<SignupConfirmPage />} />}
            />
            <Route
              path="/signin"
            ...
            <Route
              path="/recive"
              element={<PrivateRoute element={<RecivePage />} />}
            />
            <Route
              path="/send"
